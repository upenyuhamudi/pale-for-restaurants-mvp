  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[95vw] max-w-md mx-auto p-4 sm:p-6">
        <DialogHeader>
          <DialogTitle className="text-center text-xl sm:text-2xl font-bold">Perfect Pairings</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4">
          ...
          {loading ? (
            <div className="space-y-3">
              {[1, 2, 3].map((i) => (
                <div key={i} className="animate-pulse">
                  <div className="bg-muted h-16 sm:h-20 rounded-lg"></div>
                </div>
              ))}
            </div>
                    ...
                    <CardContent className="p-3 sm:p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-medium text-sm sm:text-base truncate">{suggestion.name}</h4>
                        ...
                        {isAdded ? (
                          <Button
                            ...
                            variant="outline"
                            disabled
                            className="bg-green-100 border-green-300 text-green-700 flex-shrink-0 h-10 w-10 sm:h-12 sm:w-12 p-0"
                          >
                          ...
                          <Button
                            ...
                            className="bg-brand-orange hover:bg-brand-orange/90 text-white flex-shrink-0 h-10 w-10 sm:h-12 sm:w-12 p-0"
                          >
            ...
            <div className="text-center py-6 sm:py-8">
              <p className="text-xs sm:text-sm text-muted-foreground">No pairings available at the moment.</p>
            </div>
          )}

          <div className="flex gap-2 pt-2">
            <Button variant="outline" onClick={onClose} className="flex-1 bg-transparent h-12 text-sm sm:text-base">
              No Thanks
            </Button>
            <Button
              onClick={onClose}
              className="flex-1 bg-brand-purple hover:bg-brand-purple/90 h-12 text-sm sm:text-base"
            >
              Continue
            </Button>
          </div>
