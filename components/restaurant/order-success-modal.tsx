      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <DialogTitle className="text-xl font-semibold">Order Placed Successfully!</DialogTitle>
          </div>
        </DialogHeader>

        <div className="text-center space-y-4">
          {dinerName && <p className="text-lg font-medium">Thank you, {dinerName}!</p>}
          <p className="text-muted-foreground">Your order has been placed and sent to the kitchen.</p>
          ...
          <div className="flex flex-col gap-3 pt-4">
            <Button onClick={handleGoToMenu} className="w-full bg-brand-orange hover:bg-brand-orange/90 text-white">
              Back to Menu
            </Button>
            <Button onClick={handleGoToOrders} variant="outline" className="w-full bg-transparent">
              Go to Orders
            </Button>
          </div>
        </div>
